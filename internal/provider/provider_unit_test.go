...
func TestProviderExportsResourcesAndDataSources(t *testing.T) {
	...
	if want := []string{"proxmox_acl", "proxmox_group", "proxmox_lxc_container", "proxmox_lxc_snapshot", "proxmox_node_firewall_options", "proxmox_pool", "proxmox_qemu_snapshot", "proxmox_qemu_vm", "proxmox_role", "proxmox_storage", "proxmox_user", "proxmox_user_token"}; !reflect.DeepEqual(resourceNames, want) {
