...
func TestQemuVMDataSourceSchemaAttributes(t *testing.T) {
	...
	for _, key := range []string{"node", "vm_id", "name", "template", "protection", "scsihw", "tablet", "numa", "vcpus", "cpuunits", "cpulimit", "balloon", "shares", "hugepages", "serial", "tpm_state", "vga", "status", "uptime"} {
